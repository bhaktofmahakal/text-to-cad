export const DEFAULT_VIEWER_GITHUB_URL = "https://github.com/bhaktofmahakal/text-to-cad";
...
export const DEFAULT_VIEWER_SKILLS_INSTALL_COMMAND = "npx skills add bhaktofmahakal/text-to-cad";
...
export const DEFAULT_VIEWER_SKILLS_UPDATE_PROMPT =
  "Update the text-to-cad skills with `npx skills add bhaktofmahakal/text-to-cad`.";
