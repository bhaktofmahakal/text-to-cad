...
const skillsInstallCommand = "npx skills add bhaktofmahakal/text-to-cad";
...
const pluginInstallCommands = [
  ...
  {
    agent: "Grok Build",
    command: "grok plugin install bhaktofmahakal/text-to-cad --trust",
  },
];
...
function SkillLink({ skill }: { skill: (typeof skillGroups)[number] }) {
  return (
    <a
      ...
      href={`https://github.com/bhaktofmahakal/text-to-cad/blob/main/${skill.path}/SKILL.md`}
      target="_blank"
      rel="noreferrer"
    >
            ...
            <div className="max-w-3xl space-y-3">
              ...
              <p className="text-sm leading-6 text-muted-foreground">
                ...
                <a
                  ...
                  href="https://github.com/bhaktofmahakal/text-to-cad/blob/main/CONTRIBUTING.md"
                  rel="noreferrer"
                  target="_blank"
                >
                  CONTRIBUTING.md
