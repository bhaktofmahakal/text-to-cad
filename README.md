...
## 📸 Real Physical Models Generated by `text-to-cad`

Every model below is generated deterministically from prompt-synthesized parametric code and compiled via OpenCASCADE into watertight B-Rep solids (`.step`), additive manufacturing meshes (`.stl`, `.3mf`), and interactive WebGL assets (`.glb`):

| Precision Industrial Mounting Plate | Reinforced Structural L-Bracket |
| :---: | :---: |
| <img src="assets/examples/mounting_plate_3d.png" alt="Mounting Plate 3D" width="460" /> | <img src="assets/examples/l_bracket_3d.png" alt="L-Bracket 3D" width="460" /> |
| **`mounting_plate.py`**<br>• Dimensions: `100.0 × 70.0 × 8.0 mm`<br>• Volume: `48,221 mm³` • Faces: 43 • Edges: 99<br>• Central bore, side slot, 4x M6 counterbored holes<br>• Outputs: `.step` (137 KB), `.stl` (954 KB), `.glb` (356 KB) | **`l_bracket.py`**<br>• Dimensions: `80.0 × 50.0 × 58.0 mm`<br>• Volume: `70,323 mm³` • Faces: 23 • Edges: 67<br>• Dual 8mm triangular stiffener gussets, 4x mounting bores<br>• Outputs: `.step` (58 KB), `.stl` (240 KB), `.glb` (112 KB) |
